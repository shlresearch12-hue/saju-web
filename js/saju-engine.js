...
const SajuEngine = (() => {
    ...
    const HANJA_DICT = {
        ...
        // ㄱ
        '佳':['아름다울','가',8,'목','아름다움과 빼어남'],
        '珈':['비녀옥','가',10,'금','아름다운 옥의 기운'],
        '伽':['절','가',7,'목','맑고 고요한 기운'],
        '柯':['가지','가',9,'목','나뭇가지처럼 뻗어나가는 기운'],
        '歌':['노래','가',14,'금','노래하는 즐거운 기운'],
        '褀':['아름다울','기',13,'목','아름다운 기운'],
        '觀':['볼','관',25,'목','넓게 바라보는 기운'],
        '己':['자기','기',3,'토','자기 자신의 기운'],
        '紀':['벼리','기',9,'목','시작과 기강의 기운'],
        '起':['일어날','기',10,'목','일어서는 진취의 기운'],
        '祺':['복','기',13,'목','복되고 길한 기운'],
        '璣':['구슬','기',16,'금','구슬처럼 빛나는 기운'],
        '驥':['천리마','기',27,'화','천리마처럼 뛰어난 기운'],

        // ㄴ
        '娜':['아리따울','나',10,'화','아리따운 자태의 기운'],
        '那':['나라','나',7,'화','넉넉하고 풍요로운 기운'],
        '乃':['이에','내',2,'화','연결과 이어짐의 기운'],
        '奈':['어찌','내',8,'목','인내와 극복의 기운'],
        '諾':['허락할','낙',16,'화','허락과 신뢰의 기운'],
        '年':['해','년',6,'화','해마다 새로워지는 기운'],
        '念':['생각','념',8,'화','깊이 생각하는 기운'],
        '努':['힘쓸','노',7,'화','힘써 노력하는 기운'],

        // ㄷ
        '多':['많을','다',6,'화','풍요롭고 많은 기운'],
        '達':['통달할','달',16,'화','통달하고 이루는 기운'],
        '唐':['당나라','당',10,'화','크고 넓은 기운'],
        '導':['인도할','도',16,'화','인도하고 이끄는 기운'],
        '度':['법도','도',9,'토','법도와 절도의 기운'],
        '桃':['복숭아','도',10,'목','복숭아처럼 아름다운 기운'],
        '棹':['노','도',12,'목','배를 젓는 기운'],
        '到':['이를','도',8,'화','목표에 이르는 기운'],
        '陶':['질그릇','도',16,'토','빚어 만드는 기운'],
        '敦':['도타울','돈',12,'화','도탑고 따뜻한 기운'],
        '冬':['겨울','동',5,'수','겨울의 고요한 기운'],
        '斗':['말','두',4,'화','별자리 북두의 기운'],
        '得':['얻을','득',11,'화','얻고 성취하는 기운'],

        // ㄹ
        '來':['올','래',8,'화','다가오는 미래의 기운'],
        '浪':['물결','랑',11,'수','물결처럼 자유로운 기운'],
        '樂':['즐길','락',15,'목','즐거운 기운',['악','낙']],
        '良':['어질','량',7,'화','어질고 착한 기운',['양']],
        '涼':['서늘할','량',12,'수','시원하고 맑은 기운',['양']],
        '糧':['양식','량',18,'수','양식이 되는 기운',['양']],
        '力':['힘','력',2,'화','힘차고 강한 기운',['역']],
        '鈴':['방울','령',13,'금','방울소리의 기운',['영']],
        '靈':['신령','령',24,'화','영험한 기운',['영']],
        '露':['이슬','로',20,'수','이슬처럼 맑은 기운',['노']],
        '路':['길','로',13,'화','길을 여는 기운',['노']],
        '祿':['복','록',13,'화','복록의 기운',['녹']],
        '論':['의논할','론',15,'화','논하고 의논하는 기운',['논']],
        '流':['흐를','류',10,'수','흐르는 물의 기운',['유']],
        '留':['머무를','류',10,'수','머무르며 지키는 기운',['유']],
        '律':['법칙','률',9,'화','법칙과 질서의 기운',['율']],
        '理':['다스릴','리',11,'토','다스리고 이치를 밝히는 기운',['이']],
        '璃':['유리','리',15,'금','유리처럼 투명한 기운',['이']],
        '梨':['배나무','리',11,'목','배나무의 결실 기운',['이']],
        '臨':['임할','림',17,'수','임하여 다스리는 기운',['임']],

        // ㅁ
        '摩':['갈','마',15,'수','갈고 닦는 기운'],
        '磨':['갈','마',16,'토','갈고 닦아 빛나는 기운'],
        '滿':['찰','만',15,'수','가득 차는 기운'],
        '望':['바랄','망',11,'수','바라고 기대하는 기운'],
        '旼':['화할','민',8,'화','따뜻하고 화목한 기운'],
        '汶':['물이름','문',8,'수','맑은 물의 기운'],
        '未':['아닐','미',5,'목','아직 펼쳐지지 않은 가능성'],

        // ㅂ
        '百':['일백','백',6,'수','백 가지 풍요의 기운'],
        '凡':['무릇','범',3,'수','모든 것의 시작'],
        '法':['법','법',9,'수','법도와 규범의 기운'],
        '輔':['도울','보',14,'금','돕고 보좌하는 기운'],
        '寶':['보배','보',20,'화','보배로운 기운'],
        '福':['복','복',14,'수','복이 가득한 기운'],
        '富':['부자','부',12,'수','부유한 기운'],
        '飛':['날','비',9,'수','하늘을 나는 기운'],
        '菲':['풀이름','비',14,'목','꽃처럼 아름다운 기운'],
        '彪':['범무늬','표',11,'수','호랑이 무늬의 기운'],

        // ㅅ
        '思':['생각할','사',9,'금','깊이 생각하는 기운'],
        '師':['스승','사',10,'금','가르침의 기운'],
        '使':['부릴','사',8,'금','맡은 바를 행하는 기운'],
        '詞':['말씀','사',12,'금','아름다운 말의 기운'],
        '嗣':['이을','사',13,'금','대를 잇는 기운'],
        '常':['항상','상',11,'금','변함없는 기운'],
        '想':['생각할','상',13,'금','생각하는 기운'],
        '庠':['학교','상',10,'금','배움의 기운'],
        '書':['글','서',10,'금','글과 학문의 기운'],
        '西':['서녘','서',6,'금','서쪽의 기운'],
        '先':['먼저','선',6,'금','앞서 나아가는 기운'],
        '宣':['베풀','선',9,'금','베풀고 알리는 기운'],
        '仙':['신선','선',5,'금','신선의 기운'],
        '瑄':['옥이름','선',14,'금','아름다운 옥의 기운'],
        '璇':['옥이름','선',16,'금','구슬처럼 빛나는 기운'],
        '紹':['이을','소',11,'금','이어나가는 기운'],
        '殊':['다를','수',10,'금','특별하고 뛰어난 기운'],
        '順':['순할','순',12,'금','순하고 온화한 기운'],
        '純':['순수할','순',10,'금','순수한 기운'],
        '勝':['이길','승',12,'금','이기고 승리하는 기운'],
        '施':['베풀','시',9,'금','베푸는 기운'],
        '詩':['시','시',13,'금','시처럼 아름다운 기운'],
        '新':['새','신',13,'금','새로운 기운'],
        '莘':['풀이름','신',13,'목','풀처럼 자라는 기운'],
        '實':['열매','실',14,'금','열매 맺는 기운'],

        // ㅇ
        '我':['나','아',7,'금','자아의 기운'],
        '巖':['바위','암',23,'토','바위처럼 든든한 기운'],
        '厄':['재앙','액',4,'토','어려움을 극복하는 기운'],
        '野':['들','야',11,'토','넓은 들판의 기운'],
        '若':['같을','약',11,'목','부드러운 기운'],
        '陽':['볕','양',17,'토','양지바른 기운'],
        '讓':['사양할','양',28,'금','사양하고 겸손한 기운'],
        '嚴':['엄할','엄',20,'목','엄격한 기운'],
        '業':['업','업',13,'목','큰 일을 이루는 기운'],
        '然':['그럴','연',12,'화','자연스러운 기운'],
        '演':['펼','연',15,'수','펼쳐 보이는 기운'],
        '緣':['인연','연',15,'목','인연의 기운'],
        '硏':['갈','연',11,'금','갈고 닦아 연구하는 기운'],
        '鉛':['납','연',13,'금','단단한 기운'],
        '炎':['불꽃','염',8,'화','불꽃의 기운'],
        '營':['경영할','영',17,'화','경영하고 다스리는 기운'],
        '影':['그림자','영',15,'토','그림자의 기운'],
        '睿':['슬기로울','예',14,'금','슬기롭고 지혜로운 기운'],
        '芮':['풀이름','예',10,'목','풀처럼 생명력 있는 기운'],
        '五':['다섯','오',4,'토','다섯의 기운'],
        '午':['낮','오',4,'화','한낮의 기운'],
        '吾':['나','오',7,'목','자신의 기운'],
        '友':['벗','우',4,'토','우정의 기운'],
        ...
        '又':['또','우',2,'토','더하는 기운'],
        '右':['오른쪽','우',5,'토','바른쪽의 기운'],
        '郁':['향기로울','욱',13,'수','향기로운 기운'],
        '云':['이를','운',4,'수','말하는 기운'],
        '運':['운','운',16,'수','운명의 기운'],
        '源':['근원','원',14,'수','근원의 기운'],
        '園':['동산','원',13,'토','동산의 기운'],
        '院':['집','원',10,'토','집의 기운'],
        '願':['원할','원',19,'목','소원을 이루는 기운'],
        '月':['달','월',4,'수','달빛의 기운'],
        '偉':['클','위',11,'토','크고 위대한 기운'],
        '威':['위엄','위',9,'토','위엄 있는 기운'],
        '位':['자리','위',7,'토','자리를 지키는 기운'],
        '韋':['가죽','위',9,'토','부드러우면서 강한 기운'],
        '裕':['넉넉할','유',13,'금','넉넉한 기운'],
        '由':['말미암을','유',5,'토','근원으로부터의 기운'],
        '遊':['놀','유',16,'수','자유로이 노니는 기운'],
        '愉':['즐거울','유',13,'금','즐거운 기운'],
        '油':['기름','유',9,'수','윤택한 기운'],
        '唯':['오직','유',11,'토','오직 하나뿐인 기운'],
        '幼':['어릴','유',5,'토','어린아이의 순수한 기운'],
        '潾':['맑을','린',16,'수','맑은 물의 기운'],
        '凝':['엉길','응',16,'수','모이고 맺히는 기운'],
        '懿':['아름다울','의',22,'토','아름답고 덕 있는 기운'],
        '宜':['마땅할','의',8,'목','마땅하고 적절한 기운'],
        '依':['의지할','의',8,'토','의지하고 기대는 기운'],
        '二':['두','이',2,'화','둘의 기운'],
        '以':['써','이',5,'화','쓰임의 기운'],
        '異':['다를','이',12,'화','다르고 뛰어난 기운'],
        '寅':['범','인',11,'토','호랑이의 기운'],
        '忍':['참을','인',7,'금','참고 인내하는 기운'],
        '印':['도장','인',6,'수','도장의 기운'],
        '認':['알','인',14,'금','인정하는 기운'],
        '一':['한','일',1,'수','하나의 으뜸 기운'],
        '逸':['편안할','일',15,'토','편안하고 자유로운 기운'],
        '壹':['하나','일',12,'수','하나로 통일하는 기운'],

        // ㅈ
        '子':['아들','자',3,'수','아들의 기운'],
        '姿':['모양','자',9,'금','아름다운 자태의 기운'],
        '慈':['사랑할','자',14,'수','자애로운 기운'],
        '紫':['자주빛','자',12,'금','고귀한 자주빛 기운'],
        '資':['재물','자',13,'금','재물의 기운'],
        '長':['긴','장',8,'화','길고 오래가는 기운'],
        '章':['글','장',11,'화','글의 기운'],
        '莊':['엄숙할','장',13,'목','엄숙한 기운'],
        '壯':['씩씩할','장',7,'금','씩씩한 기운'],
        '將':['장수','장',11,'금','장수의 기운'],
        ...
        '財':['재물','재',10,'금','재물의 기운'],
        '典':['법','전',8,'화','법전의 기운'],
        '展':['펼','전',10,'금','펼쳐 나가는 기운'],
        '前':['앞','전',9,'금','앞서 나가는 기운'],
        '靜':['고요할','정',16,'금','고요한 기운'],
        '廷':['조정','정',7,'화','조정의 기운'],
        '貞':['곧을','정',9,'화','곧고 바른 기운'],
        '禎':['상서로울','정',14,'목','상서로운 기운'],
        '情':['뜻','정',12,'금','정이 깊은 기운'],
        '祚':['복','조',10,'화','복의 기운'],
        '造':['지을','조',14,'금','만들어내는 기운'],
        '組':['짤','조',11,'금','조직하는 기운'],
        '朝':['아침','조',12,'목','아침의 기운'],
        '宗':['마루','종',8,'금','으뜸의 기운'],
        '鍾':['쇠북','종',17,'금','종소리의 기운',['종']],
        '種':['씨','종',14,'화','씨앗의 기운'],
        '走':['달릴','주',7,'화','달리는 기운'],
        '駿':['준마','준',17,'금','준마의 기운'],
        '準':['준거','준',14,'수','기준의 기운'],
        '中':['가운데','중',4,'화','가운데의 기운'],
        '衆':['무리','중',12,'금','많은 사람의 기운'],
        '之':['갈','지',4,'화','나아가는 기운'],
        '地':['땅','지',6,'토','땅의 기운'],
        '知':['알','지',8,'화','아는 기운'],
        '指':['가리킬','지',10,'금','가리키는 기운'],
        '進':['나아갈','진',15,'금','나아가는 기운'],

        // ㅊ
        '采':['캘','채',8,'화','빛나는 기운'],
        '喆':['밝을','철',12,'금','밝고 명철한 기운'],
        '鐵':['쇠','철',21,'금','쇠처럼 강한 기운'],
        '初':['처음','초',7,'금','처음의 기운'],
        '草':['풀','초',12,'목','풀의 기운'],
        '充':['채울','충',6,'토','가득 채우는 기운'],
        '翠':['비취','취',14,'금','비취처럼 푸른 기운'],

        // ㅌ
        '太':['클','태',4,'화','크고 위대한 기운'],
        '擇':['가릴','택',17,'금','가리고 선택하는 기운'],
        '統':['거느릴','통',12,'금','거느리고 통솔하는 기운'],
        '通':['통할','통',14,'금','통하고 관통하는 기운'],

        // ㅍ
        '八':['여덟','팔',2,'금','여덟의 기운'],
        '彭':['성할','팽',12,'수','성하고 가득한 기운'],
        '便':['편할','편',9,'수','편안한 기운'],
        '平':['평평할','평',5,'수','평화로운 기운'],
        '豊':['풍년','풍',18,'수','풍년의 기운'],
        '風':['바람','풍',9,'수','바람의 기운'],
        '弼':['도울','필',12,'수','돕는 기운'],
        '必':['반드시','필',5,'수','반드시 이루는 기운'],

        // ㅎ
        '賀':['하례할','하',12,'수','축하의 기운'],
        '霞':['노을','하',17,'수','노을빛의 기운'],
        '遐':['멀','하',16,'토','먼 곳까지 미치는 기운'],
        '廈':['큰집','하',13,'토','큰 집의 기운'],
        '翰':['깃','한',16,'수','붓의 기운'],
        '閑':['한가할','한',12,'목','한가한 기운'],
        '恨':['한','한',10,'금','한의 기운'],
        '奚':['어찌','해',10,'금','어찌의 기운'],
        '幸':['다행','행',8,'수','행복한 기운'],
        '行':['다닐','행',6,'수','다니고 행하는 기운'],
        '享':['누릴','향',8,'수','누리는 기운'],
        '香':['향기','향',9,'수','향기로운 기운'],
        '向':['향할','향',6,'수','향하는 기운'],
        '鄕':['시골','향',17,'수','고향의 기운'],
        '獻':['바칠','헌',20,'목','바치는 기운'],
        '絃':['줄','현',11,'금','거문고 줄의 기운'],
        '弦':['활시위','현',8,'수','활시위의 기운'],
        '協':['화합할','협',8,'금','화합하는 기운'],
        '兄':['형','형',5,'수','형의 기운'],
        '螢':['반딧불','형',16,'화','반딧불의 기운'],
        '虎':['범','호',8,'수','호랑이의 기운'],
        '紅':['붉을','홍',9,'금','붉은 기운'],
        '歡':['기쁠','환',22,'수','기쁘고 즐거운 기운'],
        '還':['돌아올','환',20,'수','돌아오는 기운'],
        '皇':['임금','황',9,'토','임금의 기운'],
        '輝':['빛날','휘',15,'수','빛나는 기운'],
        '揮':['휘두를','휘',13,'수','휘두르는 기운'],
        '徽':['아름다울','휘',17,'금','아름다운 기운'],
        '曉':['새벽','효',16,'화','새벽의 기운'],
        '效':['본받을','효',10,'수','본받는 기운'],
        '後':['뒤','후',9,'수','뒤를 잇는 기운'],
        '厚':['두터울','후',9,'수','두텁고 후한 기운'],
        '熏':['연기','훈',14,'화','훈훈한 기운'],
        '喜':['기쁠','희',12,'수','기쁜 기운'],
        '曦':['햇빛','희',20,'화','햇빛의 기운'],
        '禧':['복','희',17,'수','복의 기운'],
        ...
        '竑':['클','굉',9,'목','크고 넓은 기운'],
        '宏':['클','굉',7,'수','크고 넓은 기운'],
        '鶯':['꾀꼬리','앵',21,'토','꾀꼬리의 아름다운 기운'],
        '瑰':['아름다운옥','괴',14,'토','아름다운 옥의 기운'],
        '窈':['아름다울','요',10,'수','깊고 아름다운 기운'],
        '菡':['연꽃','함',14,'목','연꽃의 아름다운 기운'],
        '茹':['먹을','여',12,'목','부드럽게 받아들이는 기운'],
        '彧':['빛날','욱',10,'수','문채가 빛나는 기운'],
        '灼':['밝을','작',7,'화','밝게 타오르는 기운'],
        '焄':['향기','훈',10,'화','향기로운 기운'],
        '沁':['스며들','심',7,'수','스며드는 기운'],
        '馨':['향기','형',20,'금','향기로운 기운'],
        '婷':['아리따울','정',12,'화','아리따운 자태의 기운'],
        '蕙':['혜초','혜',18,'목','향기로운 풀의 기운'],
        '穎':['이삭끝','영',16,'목','빼어나고 뾰족한 기운'],
        '怡':['기쁠','이',9,'토','기쁘고 화평한 기운'],
        '頌':['기릴','송',13,'금','칭송하는 기운'],
        '勤':['부지런할','근',13,'목','부지런한 기운'],
        '質':['바탕','질',15,'화','본바탕의 기운'],
        '溢':['넘칠','일',14,'수','넘치는 기운'],
        '暖':['따뜻할','난',13,'화','따뜻한 기운'],
        '穩':['편안할','온',19,'토','편안하고 안정된 기운'],
        '顏':['얼굴','안',18,'목','얼굴빛의 기운'],
        '朔':['초하루','삭',10,'수','새로운 시작의 기운'],
        '壁':['벽','벽',16,'토','벽처럼 단단한 기운'],
        '甯':['편안할','녕',12,'화','편안한 기운'],
        '斐':['아름다울','비',12,'수','문채가 아름다운 기운'],
        '馥':['향기로울','복',18,'수','향기가 진한 기운'],
        '楹':['기둥','영',13,'목','기둥처럼 든든한 기운'],
        '暄':['따뜻할','훤',13,'화','따뜻한 볕의 기운'],
        '旻':['하늘','민',8,'화','가을 하늘의 기운'],
        '昕':['해뜰','흔',8,'화','해가 뜨는 기운'],
        '昶':['긴날','창',9,'화','긴 날의 기운'],
        '柚':['유자나무','유',9,'목','유자나무의 기운'],
        '栢':['잣나무','백',10,'목','잣나무처럼 곧은 기운'],
        '桂':['계수나무','계',10,'목','계수나무의 고귀한 기운'],
        '棋':['바둑','기',12,'목','바둑처럼 전략적인 기운'],
        '椿':['참죽나무','춘',13,'목','장수하는 나무의 기운'],
        '楷':['모범','해',13,'목','모범이 되는 기운'],
        '檀':['박달나무','단',17,'목','단단한 나무의 기운'],
        '澄':['맑을','징',16,'수','맑게 가라앉는 기운'],
        '瀅':['맑을','형',19,'수','맑고 깨끗한 기운'],
        '牧':['칠','목',8,'수','기르고 다스리는 기운'],
        '瑗':['옥이름','원',14,'금','아름다운 옥의 기운'],
        '瑢':['옥빛','용',14,'금','옥처럼 빛나는 기운'],
        '瑪':['마노','마',15,'금','보석의 기운'],
        '璐':['아름다운옥','로',17,'금','아름다운 옥의 기운'],
        '皓':['흰','호',12,'수','희고 밝은 기운'],
        '穹':['하늘','궁',8,'목','하늘의 기운'],
        '竣':['마칠','준',12,'금','완성하는 기운'],
        '紘':['끈','굉',10,'금','연결하는 기운'],
        '綺':['비단','기',14,'금','비단처럼 아름다운 기운'],
        '翊':['도울','익',11,'금','도와서 날게 하는 기운'],
        '翎':['깃','령',11,'금','깃털의 기운',['영']],
        '耿':['빛날','경',10,'화','밝게 빛나는 기운'],
        '肇':['비로소','조',14,'금','처음 시작하는 기운'],
        '蕊':['꽃술','예',18,'목','꽃술처럼 아름다운 기운'],
        '誼':['의리','의',15,'금','의리의 기운'],
        '諄':['간곡할','순',16,'금','간곡하게 타이르는 기운'],
        '讚':['기릴','찬',26,'금','칭찬하고 기리는 기운'],
        '豫':['미리','예',16,'수','미리 준비하는 기운'],
        '軒':['처마','헌',10,'금','높은 처마의 기운'],
        '邃':['깊을','수',19,'수','깊은 기운'],
        '鑰':['열쇠','약',25,'금','열쇠의 기운'],
        '鑠':['녹일','삭',23,'금','녹여 만드는 기운'],
        '顥':['밝을','호',21,'수','밝고 큰 기운'],
        '馳':['달릴','치',13,'화','달리는 기운'],
        '驊':['준마','화',22,'목','준마의 기운'],
    };
